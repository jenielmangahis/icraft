...
*/
$url = "";
$config['base_url'] = "http://localhost/farris/instacraft/";
...
$version        = isset($headerData['BundleVersion']) ? $headerData['BundleVersion'] : '';
$authToken      = isset($headerData['token']) ? $headerData['token'] : '';
if($version==''){
    $version="1.0";    
}
//$authkey     = $headerData['AuthenticationKey'];
 //$version = '1.0';

$config['api_version']  = $version;
$config['api_path']     = 'webservics'.$version;
